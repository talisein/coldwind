...
# optional components like gtkmm, glade, glademm, and gthread.
#
...
#       find_package(GTK3 2.10 REQUIRED gtk glade)
#
...
# Version 1.4 (2/22/2012) 
#   * Create FindGTK3 based on FindGTK2
#
...
foreach(_GTK3_component ${GTK3_FIND_COMPONENTS})
    ...
    elseif(_GTK3_component STREQUAL "gthread")
...
foreach(_GTK3_component ${GTK3_FIND_COMPONENTS})
    ...
    elseif(_GTK3_component STREQUAL "gthread")
        FIND_PACKAGE_HANDLE_STANDARD_ARGS(GTK3_${_COMPONENT_UPPER} "The gthread library was not found."
